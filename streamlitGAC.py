...
def getUNSDG(data):
    ...
    The SDG goal number and name should be typed in bold font, followed by an explanation of why you think the project is aligned to this goal. Reference the sub goals in cases where there is a clear connection with the subgoal and the project..
